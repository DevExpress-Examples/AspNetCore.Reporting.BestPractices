...
export const ApplicationName = 'AspNetCore.Reporting.Angular.Client';
...
let applicationPaths: ApplicationPathsType = {
  ...
  ApiAuthorizationClientConfigurationUrl: `${environment.serverUri}_configuration/${ApplicationName}`,
